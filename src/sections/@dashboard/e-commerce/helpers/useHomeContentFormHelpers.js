...
export function useStepHandlerHomeContent(currentHomeContent) {
  ...
  const { mutateAsync: updateHomeContent  } = useUpdateHomeContentMutation();
  ...
  const NewHomeContentSchema = Yup.object().shape({
    banner_fir_title_en: Yup.string().required(`${translate('HomeContent.banner_fir_title_en.error')}`),
    banner_fir_title_ar: Yup.string().required(`${translate('HomeContent.banner_fir_title_ar.error')}`),
    banner_sec_title_en: Yup.string().required(`${translate('HomeContent.banner_sec_title_en.error')}`),
    banner_sec_title_ar: Yup.string().required(`${translate('HomeContent.banner_sec_title_ar.error')}`),
    banner_third_title_en: Yup.string().required(`${translate('HomeContent.banner_third_title_en.error')}`),
    banner_third_title_ar: Yup.string().required(`${translate('HomeContent.banner_third_title_ar.error')}`),
    banner_btn_en: Yup.string().required(`${translate('HomeContent.banner_btn_en.error')}`),
    banner_btn_ar: Yup.string().required(`${translate('HomeContent.banner_btn_ar.error')}`),
    service_fir_title_en: Yup.string().required(`${translate('HomeContent.service_fir_title_en.error')}`),
    service_fir_title_ar: Yup.string().required(`${translate('HomeContent.service_fir_title_ar.error')}`),
    service_fir_sub_title_en: Yup.string().required(`${translate('HomeContent.service_fir_sub_title_en.error')}`),
    service_fir_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_fir_sub_title_ar.error')}`),
    service_sec_title_en: Yup.string().required(`${translate('HomeContent.service_sec_title_en.error')}`),
    service_sec_title_ar: Yup.string().required(`${translate('HomeContent.service_sec_title_ar.error')}`),
    service_sec_sub_title_en: Yup.string().required(`${translate('HomeContent.service_sec_sub_title_en.error')}`),
    service_sec_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_sec_sub_title_ar.error')}`),
    service_third_title_en: Yup.string().required(`${translate('HomeContent.service_third_title_en.error')}`),
    service_third_title_ar: Yup.string().required(`${translate('HomeContent.service_third_title_ar.error')}`),
    service_third_sub_title_en: Yup.string().required(`${translate('HomeContent.service_third_sub_title_en.error')}`),
    service_third_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_third_sub_title_ar.error')}`),
    service_forth_title_en: Yup.string().required(`${translate('HomeContent.service_forth_title_en.error')}`),
    service_forth_title_ar: Yup.string().required(`${translate('HomeContent.service_forth_title_ar.error')}`),
    service_fivth_title_en: Yup.string().required(`${translate('HomeContent.service_fivth_title_en.error')}`),
    service_fivth_title_ar: Yup.string().required(`${translate('HomeContent.service_fivth_title_ar.error')}`),
    service_sex_title_en: Yup.string().required(`${translate('HomeContent.service_sex_title_en.error')}`),
    service_sex_title_ar: Yup.string().required(`${translate('HomeContent.service_sex_title_ar.error')}`),
    service_seven_title_en: Yup.string().required(`${translate('HomeContent.service_seven_title_en.error')}`),
    service_seven_title_ar: Yup.string().required(`${translate('HomeContent.service_seven_title_ar.error')}`),
    know_us_title_en: Yup.string().required(`${translate('HomeContent.know_us_title_en.error')}`),
    know_us_title_ar: Yup.string().required(`${translate('HomeContent.know_us_title_ar.error')}`),
    know_us_sub_title_en: Yup.string().required(`${translate('HomeContent.know_us_sub_title_en.error')}`),
    know_us_sub_title_ar: Yup.string().required(`${translate('HomeContent.know_us_sub_title_ar.error')}`),
    know_us_sec_title_en: Yup.string().required(`${translate('HomeContent.know_us_sec_title_en.error')}`),
    know_us_sec_title_ar: Yup.string().required(`${translate('HomeContent.know_us_sec_title_ar.error')}`),
    know_us_fir_item_en: Yup.string().required(`${translate('HomeContent.know_us_fir_item_en.error')}`),
    know_us_fir_item_ar: Yup.string().required(`${translate('HomeContent.know_us_fir_item_ar.error')}`),
    know_us_sec_item_en: Yup.string().required(`${translate('HomeContent.know_us_sec_item_en.error')}`),
    know_us_sec_item_ar: Yup.string().required(`${translate('HomeContent.know_us_sec_item_ar.error')}`),
    know_us_third_item_en: Yup.string().required(`${translate('HomeContent.know_us_third_item_en.error')}`),
    know_us_third_item_ar: Yup.string().required(`${translate('HomeContent.know_us_third_item_ar.error')}`),
    know_us_left_title_en: Yup.string().required(`${translate('HomeContent.know_us_left_title_en.error')}`),
    know_us_left_title_ar: Yup.string().required(`${translate('HomeContent.know_us_left_title_ar.error')}`),
    why_choose_title_en: Yup.string().required(`${translate('HomeContent.why_choose_title_en.error')}`),
    why_choose_title_ar: Yup.string().required(`${translate('HomeContent.why_choose_title_ar.error')}`),
    why_choose_left_title_en: Yup.string().required(`${translate('HomeContent.why_choose_left_title_en.error')}`),
    why_choose_left_title_ar: Yup.string().required(`${translate('HomeContent.why_choose_left_title_ar.error')}`),
    why_choose_fir_item_en: Yup.string().required(`${translate('HomeContent.why_choose_fir_item_en.error')}`),
    why_choose_fir_item_ar: Yup.string().required(`${translate('HomeContent.why_choose_fir_item_ar.error')}`),
    why_choose_sec_item_en: Yup.string().required(`${translate('HomeContent.why_choose_sec_item_en.error')}`),
    why_choose_sec_item_ar: Yup.string().required(`${translate('HomeContent.why_choose_sec_item_ar.error')}`),
    banner_photo: Yup.object().nullable().shape({
      id: Yup.string().required(`${translate('HomeContent.banner_photo.error')}`)
    }),
    banner_photo_ar: Yup.object().nullable().shape({
      id: Yup.string().required(`${translate('HomeContent.banner_photo_ar.error')}`)
    }),

    know_us_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.know_us_photo.error')}`)
    }),
    know_us_photo_ar: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.know_us_photo_ar.error')}`)
    }),

    why_choose_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.why_choose_photo.error')}`)
    }),
    why_choose_photo_ar: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.why_choose_photo_ar.error')}`)
    }),

    ready_to_travel_title_en: Yup.string().required(`${translate('HomeContent.ready_to_travel_title_en.error')}`),
    ready_to_travel_title_ar: Yup.string().required(`${translate('HomeContent.ready_to_travel_title_ar.error')}`),
    ready_to_travel_sub_title_en: Yup.string().required(`${translate('HomeContent.ready_to_travel_sub_title_en.error')}`),
    ready_to_travel_sub_title_ar: Yup.string().required(`${translate('HomeContent.ready_to_travel_sub_title_ar.error')}`),

    percentage: Yup.string().required(`${translate('HomeContent.percentage.error')}`),


    why_choose_sec_item_desc_ar: Yup.string().required(`${translate('HomeContent.why_choose_sec_item_desc_ar.error')}`),
    why_choose_sec_item_desc_en: Yup.string().required(`${translate('HomeContent.why_choose_sec_item_desc_en.error')}`),
    why_choose_fir_item_desc_ar: Yup.string().required(`${translate('HomeContent.why_choose_fir_item_desc_ar.error')}`),
    why_choose_fir_item_desc_en: Yup.string().required(`${translate('HomeContent.why_choose_fir_item_desc_en.error')}`),
    service_seven_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_seven_sub_title_ar.error')}`),
    service_seven_sub_title_en: Yup.string().required(`${translate('HomeContent.service_sex_sub_title_ar.error')}`),
    service_sex_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_sex_sub_title_ar.error')}`),
    service_sex_sub_title_en: Yup.string().required(`${translate('HomeContent.service_sex_sub_title_en.error')}`),
    service_fivth_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_fivth_sub_title_ar.error')}`),
    service_fivth_sub_title_en: Yup.string().required(`${translate('HomeContent.service_fivth_sub_title_en.error')}`),
    service_forth_sub_title_ar: Yup.string().required(`${translate('HomeContent.service_forth_sub_title_ar.error')}`),
    service_forth_sub_title_en: Yup.string().required(`${translate('HomeContent.service_forth_sub_title_en.error')}`),
    ready_to_travel_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.ready_to_travel_photo.error')}`)
    }),
    ready_to_travel_sec_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.ready_to_travel_sec_photo.error')}`)
    }),
    ready_to_travel_third_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.ready_to_travel_third_photo.error')}`)
    }),
    ready_to_travel_forth_photo: Yup.object().shape({
      id: Yup.string().required(`${translate('HomeContent.ready_to_travel_forth_photo.error')}`)
    }),
  });
  ...
  const [defaultValues, setDefaultValues] = useState({
    ...
    percentage: "50%",
    why_choose_sec_item_desc_ar: "why_choose_sec_item_desc_ar",
    why_choose_sec_item_desc_en: "why_choose_sec_item_desc_en",
    why_choose_fir_item_desc_ar: "why_choose_fir_item_desc_ar",
    why_choose_fir_item_desc_en: "why_choose_fir_item_desc_en",
    service_seven_sub_title_ar: "service_seven_sub_title_ar",
    service_seven_sub_title_en: "service_seven_sub_title_en",
    service_sex_sub_title_ar: "service_sex_sub_title_ar",
    service_sex_sub_title_en: "service_sex_sub_title_en",
    service_fivth_sub_title_ar: "service_fivth_sub_title_ar",
    service_fivth_sub_title_en: "service_fivth_sub_title_en",
    service_forth_sub_title_ar: "service_forth_sub_title_ar",
    service_forth_sub_title_en: "service_forth_sub_title_en",
  ...
  useEffect(() => {
    if (dataLoaded && HomeContentsData) {
      setDefaultValues((prevValues) => ({
        ...
        percentage: HomeContentsData.percentage || prevValues?.percentage,
        why_choose_sec_item_desc_ar: HomeContentsData.why_choose_sec_item_desc_ar || prevValues?.why_choose_sec_item_desc_ar,
        why_choose_sec_item_desc_en: HomeContentsData.why_choose_sec_item_desc_en || prevValues?.why_choose_sec_item_desc_en,
        why_choose_fir_item_desc_ar: HomeContentsData.why_choose_fir_item_desc_ar || prevValues?.why_choose_fir_item_desc_ar,
        why_choose_fir_item_desc_en: HomeContentsData.why_choose_fir_item_desc_en || prevValues?.why_choose_fir_item_desc_en,
        service_seven_sub_title_ar: HomeContentsData.service_seven_sub_title_ar || prevValues?.service_seven_sub_title_ar,
        service_seven_sub_title_en: HomeContentsData.service_seven_sub_title_en || prevValues?.service_seven_sub_title_en,
        service_sex_sub_title_ar: HomeContentsData.service_sex_sub_title_ar || prevValues?.service_sex_sub_title_ar,
        service_sex_sub_title_en: HomeContentsData.service_sex_sub_title_en || prevValues?.service_sex_sub_title_en,
        service_fivth_sub_title_ar: HomeContentsData.service_fivth_sub_title_ar || prevValues?.service_fivth_sub_title_ar,
        service_fivth_sub_title_en: HomeContentsData.service_fivth_sub_title_en || prevValues?.service_fivth_sub_title_en,
        service_forth_sub_title_ar: HomeContentsData.service_forth_sub_title_ar || prevValues?.service_forth_sub_title_ar,
        service_forth_sub_title_en: HomeContentsData.service_forth_sub_title_en || prevValues?.service_forth_sub_title_en,
        ready_to_travel_photo: {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      const updatedHomeContent = {
        ...
        percentage: formData.percentage || HomeContentsData?.percentage,


        why_choose_sec_item_desc_ar: formData.why_choose_sec_item_desc_ar || HomeContentsData?.why_choose_sec_item_desc_ar,
        why_choose_sec_item_desc_en: formData.why_choose_sec_item_desc_en || HomeContentsData?.why_choose_sec_item_desc_en,
        why_choose_fir_item_desc_ar: formData.why_choose_fir_item_desc_ar || HomeContentsData?.why_choose_fir_item_desc_ar,
        why_choose_fir_item_desc_en: formData.why_choose_fir_item_desc_en || HomeContentsData?.why_choose_fir_item_desc_en,
        service_seven_sub_title_ar: formData.service_seven_sub_title_ar || HomeContentsData?.service_seven_sub_title_ar,
        service_seven_sub_title_en: formData.service_seven_sub_title_en || HomeContentsData?.service_seven_sub_title_en,
        service_sex_sub_title_ar: formData.service_sex_sub_title_ar || HomeContentsData?.service_sex_sub_title_ar,
        service_sex_sub_title_en: formData.service_sex_sub_title_en || HomeContentsData?.service_sex_sub_title_en,
        service_fivth_sub_title_ar: formData.service_fivth_sub_title_ar || HomeContentsData?.service_fivth_sub_title_ar,
        service_fivth_sub_title_en: formData.service_fivth_sub_title_en || HomeContentsData?.service_fivth_sub_title_en,
        service_forth_sub_title_ar: formData.service_forth_sub_title_ar || HomeContentsData?.service_forth_sub_title_ar,
        service_forth_sub_title_en: formData.service_forth_sub_title_en || HomeContentsData?.service_forth_sub_title_en,
      ...
      await updateHomeContent(updatedHomeContent);
      ...
      // تأكد من إعادة تعيين الحالة إلى false بعد اكتمال العملية
      setIsLoading(false);
    }
  };
