...
export default function FeatureTableRow({ openConfirm,
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell align="left" dangerouslySetInnerHTML={{ __html: row.answer_ar }} />

        <TableCell align="left" dangerouslySetInnerHTML={{ __html: row.answer_en }} />
