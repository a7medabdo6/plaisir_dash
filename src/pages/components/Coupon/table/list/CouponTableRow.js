...
export default function CouponTableRow({ openConfirm,
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        content={`${translate('coupon.are_you_sure_to_delete')}`}
        action={
          <Button disabled={loading} variant="contained" color="error" onClick={onDeleteRow}>
            {loading ? translate('coupon.loading') : translate('coupon.delet')}
