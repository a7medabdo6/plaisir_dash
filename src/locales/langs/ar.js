...
quesAr: "السؤال باللغة العربية",
  ...
  bloging: {
    ...
    errors:{
      ...
      tags: {
        min: "يجب أن يحتوي على الأقل على1  وسم"
      },
      metaKeywords: {
...
Order:"ألطلبات",
  ...
  deleteError: "حدث خطأ أثناء حذف الفئة. يرجى المحاولة مرة أخرى.",
  editSuccess: "تم تحديث الفئة بنجاح!",
  editError: "حدث خطأ أثناء تحديث الفئة. يرجى المحاولة مرة أخرى.",
